			...
			<table class="table table-hover" >
				...
				<tbody>
					  ...
					  <%
						...
						List<Store> list=pageBean.getData();
					...
					<tr>
						...
						<td>
							<a href="/Car/store-info.action?s.id=<%=store.getId() %>" class="btn btn-primary btn-sm" role="button">查看</a>
						</td>
					</tr>
					<% } %>
				</tbody>
			 ...
			 <div id="pageButton" style="text-align:center;">
						<form name="PageForm" action="/Car/store-list.action" method="post">					
							<script>
