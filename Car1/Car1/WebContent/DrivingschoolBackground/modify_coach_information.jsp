        ...
        <table class="table">
		    	...
		    	%>
					<tr>
						...
						<td>姓名</td>
						<td>
							 <input  value="<%=drivingcoach.getName() %>" style="margin-left:;" type="text"  class="form-control" id="exampleInputEmail1"  />	
						</td>
					</tr>
					<tr >
						...
						<td>性别</td>
						<td>
							<input value="<%=drivingcoach.getSex() %>" style="margin-left:;" type="text"  class="form-control" id="exampleInputEmail1"  />	
						</td>
					</tr>
                    <tr >
						...
						<td>电话号码</td>
						<td>
							<input value="<%=drivingcoach.getPhoneNumber() %>" style="margin-left:;" type="text"  class="form-control" id="exampleInputEmail1"  />	
						</td>
					</tr>
					<tr >
						...
						<td>描述</td>
						<td>
							 <textarea value="<%=drivingcoach.getDescription() %>" style=" width:410px;class="form-control" rows="3"></textarea>
						</td>
					</tr>
