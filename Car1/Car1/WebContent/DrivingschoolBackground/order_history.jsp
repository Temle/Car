...
<div class="container">
	...
	<div class="row clearfix">
        ...
        <form action="/Car/school-background-order-information.action">
        ...
        <table class="table table-hover" >
				...
				<%
						...
						List<Drivingorder> list=pageBean.getData();
						for(Drivingorder drivingorder:list)
						{
				    %>
					<tr>
                        ...
                        <td>
							<%=drivingorder.getPerson().getName() %>
						</td>
						<td>
							<a  href="/Car/school-background-order-information.action?id=<%=drivingorder.getId()%>" class="btn btn-primary btn-sm" role="button">查看</a>
                            <a  style="margin-left:20px;" href="store_information.html" class="btn btn-primary btn-sm" role="button">删除 </a>
