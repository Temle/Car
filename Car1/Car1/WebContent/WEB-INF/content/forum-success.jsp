	...
	<div class="row clearfix">
		...
		<div class="col-md-4 column">
			<div class="text-center">精品贴子</div>
					...
					<form name="PageFormOne" action="/Car/forum.action" method="post">
						<script>
		...
		<div class="col-md-8 column">
			...
			<table class="table table-hover">
						...
						%>
						<tr>
							<td><a href="/Car/forum-read-post.action?id=<%=post2.getId()%>"><%=post2.getTitle()%></a></td>
							<td><%=post2.getPerson().getName()%></td>
							<td><%=post2.getDate()%></td>
							<td><a href="/Car/forum-nnumber.action?id=<%=post2.getId()%>"><%=post2.getNnumber()%></a></td>
						</tr>
						<%
							}
						%>
					...
					<form name="PageForm" action="/Car/forum.action" method="post">
						<script>
