...
<div class="container">
	...
	<div class="row clearfix">
        ...
        <form action="/Car/school-background-modify-drivingschool-information.action" method="post">
        <table class="table">
		    	...
		    	%>
                    ...
                    <tr >
						...
						<td>汽车类型</td>
						<td>
							<input name="carType" value="<%=drivingschool.getCarType()%>"  type="text"  class="form-control" id="exampleInputEmail1"  />	
						</td>
					</tr>
                    <tr >
					...
					<tr >
						...
						<td>描述</td>
						<td>
							 <textarea name="description" value="<%=drivingschool.getDescription() %>" style=" width:410px;class="form-control" rows="3"></textarea>
						</td>
					</tr>
