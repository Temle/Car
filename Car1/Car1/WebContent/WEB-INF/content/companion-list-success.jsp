			...
			<table class="table table-hover" >
				...
				<tbody>
					<%
						...
						List<Drivingcompanion> list=pageBean.getData();
						for(Drivingcompanion drivingcompanion:list)
						{
				    %>
					<tr>
						<td><%=drivingcompanion.getPerson() %></td>
						<td><%=drivingcompanion.getDrivingAge() %></td>
						<td>
							<a href="/Car/companion-information.action?id=<%=drivingcompanion.getId()%>"  class="btn btn-primary btn-sm" role="button">
							查看
							</a>
						</td>
					</tr>
