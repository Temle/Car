        ...
        <table class="table table-hover" >
				...
				<tbody>
					...
					<tr>
						...
						<td>
						<form action="/Car/show-order.action">
								<input type="hidden" name="store.id" value="<%=store.getId()%>" />
								<input type="hidden" name="storeorder.id" value="<%=storeorder.getId()%>" />
			...
			<div id="pageButton" style="text-align:center;">
						<form name="PageForm" action="/Car/StoreBackstage.action?type=1" method="post">					
							<script>
