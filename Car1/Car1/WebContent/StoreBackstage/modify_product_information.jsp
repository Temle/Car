...
<div class="container">
	...
	<div class="row clearfix">
        ...
        <form action="/Car/modify-product-info.action">
        <table class="table">
				...
				<tbody>
					<tr>
						...
						<td>服务产品名称</td>
						<td>
							 <input name="product.name" value="<%=product.getName() %>" style="margin-left:;" type="text"  class="form-control" id="exampleInputEmail1"  />	
						</td>
					</tr>
					<tr >
						...
						<td>价格</td>
						<td>
							<input name="product.price" value="<%=product.getPrice() %>" style="margin-left:;" type="text"  class="form-control" id="exampleInputEmail1"  />	
						</td>
					</tr>
					<tr >
						...
						<td>描述</td>
						<td>
							 <textarea name="product.description" style=" width:410px;class="form-control" rows="3"><%=product.getDescription() %></textarea>
						</td>
					</tr>
